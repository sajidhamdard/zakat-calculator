  ...
  const translations = {
    hi: {
      ...
      nisabNote: 'निसाब विकल्प न चुनने पर केवल आपकी कुल संपत्ति के आधार पर ज़कात की गणना दिखाई जाएगी। निसाब विकल्प चुनने पर निसाब के हिसाब से वास्तविक देय ज़कात दिखाई जाएगी।',
      resultTitle: '📊 परिणाम',
    ...
    en: {
      ...
      nisabNote: 'If no Nisab option is selected, Zakat will be calculated based on your total wealth only. If a Nisab option is selected, the actual Zakat due according to Nisab will be shown.',
      resultTitle: '📊 Results',
    ...
    ar: {
      ...
      nisabNote: 'إذا لم يُحدد خيار النصاب، ستُحسب الزكاة بناءً على إجمالي ثروتك فقط. وإذا حُدد خيار النصاب، ستظهر الزكاة الفعلية المستحقة وفقاً للنصاب.',
      resultTitle: '📊 النتائج',
    ...
    es: {
      ...
      nisabNote: 'Si no se selecciona una opción de Nisab, el Zakat se calculará únicamente en base a tu riqueza total. Si se selecciona una opción de Nisab, se mostrará el Zakat real adeudado según el Nisab.',
    ...
    fr: {
      ...
      nisabNote: 'Si aucune option de Nisab n\'est sélectionnée, le Zakat sera calculé uniquement sur la base de votre richesse totale. Si une option de Nisab est sélectionnée, le Zakat réel dû selon le Nisab sera affiché.',
    ...
    zh: {
      ...
      nisabNote: '如果未选择尼萨布选项，天课将仅基于您的总财富计算。如果选择了尼萨布选项，将显示按尼萨布计算的实际应缴天课。',
      resultTitle: '📊 结果',
    ...
    bn: {
      ...
      nisabNote: 'কোনো নিসাব বিকল্প না বেছে নিলে শুধুমাত্র আপনার মোট সম্পদের ভিত্তিতে যাকাত গণনা দেখানো হবে। নিসাব বিকল্প বেছে নিলে নিসাব অনুযায়ী প্রকৃত প্রদেয় যাকাত দেখানো হবে।',
      resultTitle: '📊 ফলাফল',
    ...
    pt: {
      ...
      nisabNote: 'Se nenhuma opção de Nisab for selecionada, o Zakat será calculado com base apenas na sua riqueza total. Se uma opção de Nisab for selecionada, o Zakat real devido conforme o Nisab será exibido.',
      resultTitle: '📊 Resultados',
    ...
    ru: {
      ...
      nisabNote: 'Если опция Нисаба не выбрана, Закат будет рассчитан только на основе вашего общего состояния. Если опция Нисаба выбрана, будет показан фактический Закат, причитающийся по Нисабу.',
    ...
    ur: {
      ...
      nisabNote: 'اگر کوئی نصاب کا اختیار نہ چنا جائے تو صرف آپ کی کل دولت کی بنیاد پر زکات کا حساب دکھایا جائے گا۔ نصاب کا اختیار چننے پر نصاب کے مطابق اصل واجب الادا زکات دکھائی جائے گی۔',
      resultTitle: '📊 نتائج',
